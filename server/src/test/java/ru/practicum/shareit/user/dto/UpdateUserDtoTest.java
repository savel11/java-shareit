...
public class UpdateUserDtoTest {
    ...
    public void testSerialize() throws Exception {
        final UpdateUserDto userDto = new UpdateUserDto("Saveliy", "sav@gmail.com");
        JsonContent<UpdateUserDto> result = jacksonTester.write(userDto);
    ...
    public void testDeserialize() throws Exception {
        ...
        UpdateUserDto dto = jacksonTester.parseObject(json);
